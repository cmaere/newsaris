...
@section('content')
	...
	<section class="panel"> 
		...
		<form name="listform" id="listform" action="{{route('chooseaction3')}}" method="POST"  enctype="multipart/form-data">
	    					...
	    					<div class="row">
	    						<div class="col-md-4">
	    							<div class="form-group">
	    								<label for="yearofstudy" class="col-md-8 control-label">Campus</label>
