	    					...
	    					<div class="row">
	    						<div class="col-md-4">
	    							<div class="form-group">
	    								...
	    								<input type='checkbox' value='YearofStudy' name='export[]'>
	    							</div>
	    							<div class="form-group">
	    							...
	    							<div class="form-group">
	    								...
	    								<input type='checkbox' value='RegNo' name='export[]' checked="checked" readonly="readonly">
	    							</div>
	    							<div class="form-group">
	    								<label for="programme" class="col-md-8 control-label">Programme</label>
	    								<input type='checkbox' value='ProgrammeofStudy' name='export[]'>
	    							</div>
	    							<div class="form-group">
