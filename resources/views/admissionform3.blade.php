...
<section class="panel"> 
  ...
  <form class="form-horizontal" action="{{ route('submitAdmissionForm')}}" method="POST">
    <fieldset>
      <legend>Information About Parents/Guardian (If Applicable)</legend>
        <div class="form-group">
          ...
          <div class="col-lg-8">
            <input type="text" class="form-control rounded rounded" id="accnumber" placeholder="enter parent/guardian's name" name="pname">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-8">
            <input type="text" class="form-control rounded rounded" id="accnumber" placeholder="enter relationship to student" name="relationship">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-8">
            <input type="text" class="form-control rounded rounded" id="accnumber" placeholder="enter parent/guardian's occupation" name="occupation">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-8">
            <input type="text" class="form-control rounded rounded" id="accnumber" placeholder="enter parent/guardian's address" name="paddress">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-8">
            <input type="text" class="form-control rounded" id="accnumber" placeholder="enter parent/guardian's email" name="pemail">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-8">
            <input type="text" class="form-control rounded" id="accnumber" placeholder="enter parent/guardian's phone" name="parphone">
          </div>
        </div>
      </fieldset>
      <fieldset>
      ...
      <div class="form-group">
        ...
        <div class="col-lg-8">
        <input type="text" class="form-control rounded" id="accnumber" placeholder="enter secondary school" name="schname">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-8">
        <input type="text" class="form-control rounded" id="accnumber" placeholder="enter student's examination number" name="examnum">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-8">
        <select class="form-control rounded" id="seccompleted" name="yearcompleted">
