...
<div id="wrap"> 
	...
	<header id="header">
		<div class="container"> <a href="#" class="logo"> <img src="{{asset('images/logo.png')}}" alt="Kamuzu College of Nursing" height="40" width="45" /> </a> <a class="login_btn" href="{URL}">{LINK-TITLE}</a>
			<ul class="soc_nav">
