...
<section class="panel"> 
	...
	<!-- END heading-->	
	<form name="listform" id="listform" action="{{route('chooseaction4')}}" method="POST">
	    					...
	    					<div class="row">
	    						<div class="col-md-4">
	    							<div class="form-group">
	    								<label for="yearofstudy" class="col-md-8 control-label">Faculty</label>
	    								<input type='checkbox' value='FacultyName' name='export[]'>
	    							</div>
	    							<div class="form-group">
	    								<label for="admissionnumber" class="col-md-8 control-label">Location</label>
	    								<input type='checkbox' value='Location' name='export[]'>
	    							</div>
	    							<div class="form-group">
	    								<label for="campus" class="col-md-8 control-label">Address</label>
	    								<input type='checkbox' value='Address' name='export[]'>
	    							</div>
	    							<div class="form-group">
	    								<label for="regnumber" class="col-md-8 control-label">Tel</label>
	    								<input type='checkbox' value='Tel' name='export[]' checked="checked" readonly="readonly">
	    							</div>
	    							<div class="form-group">
	    								<label for="programme" class="col-md-8 control-label">Email</label>
