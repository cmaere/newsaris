...
@section('content')
	...
	<section class="panel"> 
		...
		<form name="listform"  id="listform" action="{{route('chooseaction2')}}" method="POST">
	    					...
	    					<div class="row">
	    						<div class="col-md-4">
	    							<div class="form-group">
	    								<label for="scholarshipname" class="col-md-8 control-label">Scholarship Name</label>
	    								<input type='checkbox' value='s_name' name='export[]'>
	    							</div>
	    							<div class="form-group">
	    								<label for="sholarshipperiod" class="col-md-8 control-label">Scholarship Period</label>
	    								<input type='checkbox' value='s_period' name='export[]'>
	    							</div>
